    ...
    <div className="p-6 space-y-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm bg-white shadow-md rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-gray-500">{mockStudent.class}</p>
            </div>
            <div>
        ...
        <div className="bg-white shadow-md rounded-lg p-6 space-y-6">
          <div>
            <h2 className="text-xl font-bold text-gray-800">{mockStudent.name}</h2>
            <p className="text-gray-500">Ref ID: {mockStudent.ref}</p>
          </div>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <p className="font-semibold text-gray-700">Sexe</p>
              <p className="text-gray-500">{mockStudent.gender}</p>
            </div>
            <div>
              <p className="font-semibold text-gray-700">Date de naissance</p>
              <p className="text-gray-500">{mockStudent.birthDate}</p>
            </div>
            <div>
              <p className="font-semibold text-gray-700">Email</p>
              <p className="text-gray-500">{mockStudent.email}</p>
            </div>
            <div>
              <p className="font-semibold text-gray-700">Adresse</p>
              <p className="text-gray-500">{mockStudent.address}</p>
            </div>
            <div>
              <p className="font-semibold text-gray-700">Département</p>
              <p className="text-gray-500">{mockStudent.department}</p>
            </div>
            <div>
              <p className="font-semibold text-gray-700">Classe</p>
              <p className="text-gray-500">{mockStudent.class}</p>
            ...
            <div>
              ...
              <p className="text-gray-500">{mockStudent.admissionDate}</p>
            </div>
            <div>
              <p className="font-semibold text-gray-700">Statut</p>
              <p className="text-green-600 font-bold">{mockStudent.status}</p>
            </div>
          </div>
