...
const MatiereModal: React.FC<MatiereModalProps> = ({ isOpen, onClose, onApply, currentValue, options }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-gray-800">{t('subject')}</DialogTitle>
        </DialogHeader>
        <div className="py-4">
