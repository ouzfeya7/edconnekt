...
const ClassNameCard: React.FC<ClassNameCardProps> = ({ className, onClassChange }) => {
  ...
  const displayName = classes.find(c => c.id === className)?.name || className;
    ...
    <>
      <div 
        className="bg-white p-4 rounded-lg shadow-sm flex flex-col justify-between cursor-pointer h-full"
