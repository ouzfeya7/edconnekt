...
interface EvaluationPeriodModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const EvaluationPeriodModal: React.FC<EvaluationPeriodModalProps> = ({ isOpen, onClose, onApply, currentValue }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-gray-800">{t('evaluation_period')}</DialogTitle>
        </DialogHeader>
        <div className="py-4">
...
export default EvaluationPeriodModal; 