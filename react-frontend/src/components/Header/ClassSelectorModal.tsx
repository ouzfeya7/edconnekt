...
const ClassSelectorModal: React.FC<ClassSelectorModalProps> = ({ isOpen, onClose, onApply, currentValue }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-gray-800">{t('select_a_class', 'Sélectionner une classe')}</DialogTitle>
        </DialogHeader>
