  ...
  const filteredMessages = initialMessages.filter(message => {
    ...
    switch (selectedCategory) {
      case 'inbox':
        ...
        break;
      case 'sent':
        // La liste des messages envoyés est déjà filtrée dans le composant parent
        ...
        {displayedMessages.map((message) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-600 truncate mt-0.5">{message.subject || message.content}</p>
            </div>
