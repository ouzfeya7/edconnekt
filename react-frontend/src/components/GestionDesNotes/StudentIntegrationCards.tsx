      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-500">
            {monthName} • Évaluation mensuelle
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-4">
          ...
          <div className="text-sm">
            <div className="text-gray-500 text-xs mb-1">Évaluation</div>
...
interface StudentIntegrationCardsProps {
  competences: Array<{
    id: string;
    label: string;
  }>;
...
const StudentIntegrationCards: React.FC<StudentIntegrationCardsProps> = ({ 
  competences, 
  notes, 
  subjectName,
  monthName 
  ...
  if (competences.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 text-lg">Aucune compétence d'intégration disponible</p>
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Évaluation d'intégration - {monthName}
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {competences.map((competence) => (
          <IntegrationCard
            ...
            monthName={monthName}
            evaluationType="Intégration mensuelle"
          />
        ))}
      </div>
    </div>
...
export default StudentIntegrationCards; 