...
|[**listAbsencesAbsencesGet**](#listabsencesabsencesget) | **GET** /absences/ | List Absences|
...
# **listAbsencesAbsencesGet**
> Array<AbsenceRead> listAbsencesAbsencesGet()
...
const { status, data } = await apiInstance.listAbsencesAbsencesGet(
    skip,
    limit
);
```
