...
```typescript
import { ResponseGetReferentialApiCompetenceReferentialsReferentialIdGet } from './api';

const instance: ResponseGetReferentialApiCompetenceReferentialsReferentialIdGet = {
    name,
    cycle,
    description,
    visibility,
