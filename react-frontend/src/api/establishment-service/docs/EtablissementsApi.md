...
> EtablissementOut createEstablishmentApiEtablissementsPost(etablissementCreate)
...
const apiInstance = new EtablissementsApi(configuration);

let etablissementCreate: EtablissementCreate; //
...
|------------- | ------------- | ------------- | -------------|
| **etablissementCreate** | **EtablissementCreate**|  | |
